...
public class Confirm_task_user extends HttpServlet {
@Override
...
try {  
		...
		try {
				...
				Integer y = Integer.valueOf(task_id);
				
				
				
				
					String statement = "Update Tasks set User_status = "+cf+" where Project_id="+ x +" and User_id='"+user_id+"' and Task_id="+y+";";
