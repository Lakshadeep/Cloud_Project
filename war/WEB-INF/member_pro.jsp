  ...
  <div id="mainContent">
   ...
   <% 
	...
	if(!rs.next()){
		...
		rs.beforeFirst();
		while(rs.next()){
		ResultSet rs1 = conn.createStatement().executeQuery("SELECT *  FROM Projects where Id="+ rs.getInt("Id") +";");
		while(rs1.next()){
...
%>
    <form action="team_console.jsp?name=<%out.print(rs.getString("Id"));%>&#s12s23fls" method="post">
    <table width="80%" border="0"cellspacing="4" cellpadding="3px" >
  <tr>
