					...
					<div class="12u" id="menu">
						<nav class="mobileUI-site-nav">
							<ul>
								...
								<li class="current_page_item"><a href="admin_pros.jsp">Admin</a></li>
							...
							<div class="row">
								<div class="8u">
									<section id="content">
										...
										<p class="subtitle">Projects managed by you</p>
   <% 
	String url = null;
	...
	ResultSet rs = conn.createStatement().executeQuery("SELECT *  FROM Projects where Leader = '"+ s +"';");
	if(!rs.next()){
		%>
		<table width="80%" border="0"cellspacing="4" cellpadding="3px" >
  		<tr>
    	<td bgcolor="#CCCCFF"><p class="subtitle">Currently you are not managing any project.</p></td>
    	</tr>
...
%>
    		<form action="admin_console.jsp?name=<%out.print(rs.getString("Id"));%>&#s12s23fls" method="post">
    		<table width="80%" border="0"cellspacing="4" cellpadding="3px" >
  			<tr>
    		<td bgcolor="#CCCCFF" width="80%">&nbsp;<% out.print(name); %></td>
    		<td bgcolor="#CCCCFF" width="20%"><input type="submit" value="Admin Console" class="button-style1"/></td>
