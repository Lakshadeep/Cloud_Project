...
<div id="page-wrapper">
						...
						<div class="12u">
							<div class="row">
								...
								<div class="8u mobileUI-main-content">
									<section id="content">
									<p class="subtitle">Create New Task</p>
  
    
    <form action="/New_task_submission?pro_name=<% out.print(session.getAttribute("pro_name")); %>&uname=<%out.print(request.getParameter("uname")); %>" method="post">
   <table width="100%" border="0" cellspacing="4" cellpadding="5" bgcolor="#FFFFFF" cellspacing="3">
  <tr>
    <td>Task:</td>
    <td><input type="text" name="task"  size="45"></td>
  </tr>
  <tr>
    <td>Points on Completion</td>
    <td><input type="text" name="points" size="45"></td>
  </tr>
  <tr>
  ...
  <tr>
     <td>Deadline:</td>
    <td><input type="text" name="ddate" size="45" ></td>
  </tr>
